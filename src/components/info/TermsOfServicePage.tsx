    ...
    <div className={`min-h-screen bg-gradient-to-b from-[#f8f8f8] via-[#f0f0f0] to-[#e8e8e8] ${skipAnimations ? '[&_*]:!animate-none' : ''}`}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <span className="text-[#b90e0a] font-medium">Terms of Service</span>
        </div>

        <div className="bg-white rounded-2xl p-6 md:p-10 shadow-sm border border-black/5 text-[#333]">
      <h1 className="text-3xl md:text-4xl font-black mb-6 text-[#0a0a0a] font-akira">KALLKEYY <span className="text-[#b90e0a]">TERMS OF SERVICE</span></h1>
      <br />
      <div className="mb-8 space-y-2">
        <p className="text-gray-700 text-sm"><strong className="font-bold">Effective Date:</strong> November 1, 2025</p>
        <p className="text-gray-700 text-sm"><strong className="font-bold">Last Updated:</strong> November 1, 2025</p>
        <p className="text-gray-700 text-sm"><strong className="font-bold">Entity:</strong> KALLKEYY (Brand Entity under registration)</p>
        <p className="text-gray-700 text-sm"><strong className="font-bold">Registered Base:</strong> Dwarka, New Delhi, India</p>
        <p className="text-gray-700 text-sm"><strong className="font-bold">Contact:</strong> <a href="mailto:support@kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400">support@kallkeyy.com</a></p>
        <p className="text-gray-700 text-sm"><strong className="font-bold">Website:</strong> <a href="https://www.kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400" target="_blank" rel="noopener noreferrer">www.kallkeyy.com</a></p>
      </div>
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">- The website located at <strong className="font-bold">www.kallkeyy.com</strong> and all associated subdomains</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">Collectively, these are referred to as the &quot;<strong className="font-bold">Platform</strong>,&quot; &quot;<strong className="font-bold">Website</strong>,&quot; &quot;<strong className="font-bold">Services</strong>,&quot; or &quot;<strong className="font-bold">Site</strong>.&quot;</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">1.2 Binding Effect and Consent</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">By accessing, browsing, registering an account, placing an order, or otherwise using the Platform in any manner, you:</strong></p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">1. <strong className="font-bold">Acknowledge</strong> that you have read, understood, and agree to be bound by these Terms in their entirety</p>
      <p className="text-gray-700 mb-4 leading-relaxed">2. <strong className="font-bold">Consent</strong> to the collection, use, and processing of your personal data as described in our Privacy Policy</p>
      <p className="text-gray-700 mb-4 leading-relaxed">3. <strong className="font-bold">Agree</strong> to comply with all applicable laws, regulations, and these Terms</p>
      <p className="text-gray-700 mb-4 leading-relaxed">4. <strong className="font-bold">Represent and warrant</strong> that you have the legal capacity to enter into this binding agreement</p>
      <p className="text-gray-700 mb-4 leading-relaxed">5. <strong className="font-bold">Accept</strong> any additional terms, policies, or guidelines referenced herein or made available on the Platform</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">If you do not agree to these Terms or cannot comply with them, you must immediately cease all use of the Platform and refrain from creating an account or placing orders.</strong></p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">1.3 Scope of Application</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">These Terms apply to:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">These Terms incorporate by reference and must be read in conjunction with:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Privacy Policy</strong> (governing data collection and processing)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Return, Refund, and Exchange Policy</strong> (governing post-purchase procedures)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Shipping and Delivery Policy</strong> (governing order fulfillment)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Cookie Policy</strong> (governing tracking technologies)</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">Any other policies, notices, or guidelines published on the Platform</li>
      </ul>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">In case of conflict between these Terms and other policies, these Terms shall prevail unless explicitly stated otherwise.</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">1.5 Amendments and Modifications</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY reserves the <strong className="font-bold">absolute and unconditional right</strong> to modify, amend, update, or replace any provision of these Terms at any time, in its sole discretion, without prior notice or liability.</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Notice of Changes:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Acceptance of Changes:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">These Terms are drafted in English. In case of any translation into other languages, the <strong className="font-bold">English version shall prevail</strong> in all interpretations and disputes.</p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">For the purposes of these Terms, unless the context otherwise requires:</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">2.1 Key Definitions</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">&quot;Account&quot;</strong> means a personal user profile created by a User to access, browse, purchase, and manage orders on the Platform, including login credentials, saved addresses, purchase history, and preferences.</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">&quot;Applicable Law&quot;</strong> means all laws, statutes, regulations, ordinances, rules, codes, guidelines, and directives applicable to the Platform, including but not limited to:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">&quot;Business Day&quot;</strong> means any day other than Saturday, Sunday, or a public holiday in New Delhi, India.</p>
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">&quot;Order&quot;</strong> means a request submitted by a User through the Platform to purchase one or more Products, which is subject to acceptance by KALLKEYY.</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">&quot;Order Confirmation&quot;</strong> means the email or notification sent by KALLKEYY acknowledging receipt and acceptance of an Order, constituting a binding contract for the sale and purchase of Products.</p>
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">&quot;Third-Party Service Provider&quot;</strong> means external service providers engaged by KALLKEYY to facilitate operations, including:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Razorpay</strong> (payment processing)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Shiprocket</strong> (logistics and shipping)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">MSG91</strong> (SMS and WhatsApp OTP)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Google Analytics</strong> (website analytics)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Google OAuth</strong> (authentication)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Vercel</strong> (hosting)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">MongoDB Atlas</strong> (database)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Nodemailer</strong> (email delivery)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Hostinger</strong> (domain registration)</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">&quot;User Content&quot;</strong> means any content, information, data, text, photographs, reviews, ratings, feedback, or other materials submitted, uploaded, posted, or transmitted by Users on or through the Platform.</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">2.2 Interpretation Rules</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">In these Terms:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- References to &quot;<strong className="font-bold">including</strong>&quot; or &quot;<strong className="font-bold">includes</strong>&quot; mean &quot;including but not limited to&quot; unless expressly stated otherwise</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- References to the <strong className="font-bold">singular</strong> include the plural and vice versa</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- References to <strong className="font-bold">one gender</strong> include all genders</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Headings and section titles are for <strong className="font-bold">convenience only</strong> and do not affect interpretation</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- References to &quot;<strong className="font-bold">writing</strong>&quot; or &quot;<strong className="font-bold">written</strong>&quot; include email and electronic communication</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- References to &quot;<strong className="font-bold">days</strong>&quot; mean calendar days unless specified as Business Days</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- References to <strong className="font-bold">statutory provisions</strong> include those provisions as amended, re-enacted, or replaced from time to time</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- The word &quot;<strong className="font-bold">may</strong>&quot; indicates discretion; the word &quot;<strong className="font-bold">shall</strong>&quot; or &quot;<strong className="font-bold">must</strong>&quot; indicates obligation</p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Minimum Age:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You must be at least <strong className="font-bold">18 years of age</strong> to use the Platform, create an Account, or make purchases</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Individuals under 18 years of age are <strong className="font-bold">strictly prohibited</strong> from accessing or using the Platform without parental or guardian consent and supervision</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Verification:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">By using the Platform, you represent and warrant that:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You have the <strong className="font-bold">legal capacity</strong> to enter into binding contracts under the laws of India and your jurisdiction of residence</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You are <strong className="font-bold">not prohibited</strong> by law from using the Platform or purchasing Products</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You have the <strong className="font-bold">authority</strong> to bind yourself (or your organization, if applicable) to these Terms</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- All information you provide is <strong className="font-bold">accurate, current, and complete</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You will <strong className="font-bold">update</strong> information promptly when it changes</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">3.3 Business or Organizational Use</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">If you are accessing the Platform on behalf of a business, organization, or other legal entity:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You represent that you are <strong className="font-bold">duly authorized</strong> to accept these Terms on behalf of such entity</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- The term &quot;<strong className="font-bold">you</strong>&quot; includes both you individually and the entity you represent</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Both you and the entity shall be <strong className="font-bold">jointly and severally liable</strong> for compliance with these Terms</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Territorial Scope:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- The Platform is primarily intended for users located in <strong className="font-bold">India</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Export and Import Compliance:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">The following individuals or entities are <strong className="font-bold">prohibited</strong> from using the Platform:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Requirement:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- While browsing is permitted without an Account, you <strong className="font-bold">must create an Account</strong> to:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Registration Process:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Verification:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You may be required to verify your email address or phone number via <strong className="font-bold">OTP (One-Time Password)</strong> sent through MSG91</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <p className="text-gray-700 mb-4 leading-relaxed">- Provide <strong className="font-bold">true, accurate, current, and complete</strong> information during registration and at all times</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Update</strong> your Account information promptly when it changes</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Notify KALLKEYY immediately</strong> of any unauthorized use of your Account or security breach</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">Providing false, inaccurate, or misleading information:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Your Responsibilities:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You are <strong className="font-bold">solely responsible</strong> for:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Security Best Practices:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Use a <strong className="font-bold">strong, unique password</strong> (combination of letters, numbers, special characters)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Do <strong className="font-bold">not reuse</strong> passwords from other websites or services</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Enable <strong className="font-bold">two-factor authentication</strong> (2FA) if and when available</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Unauthorized Access:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You must <strong className="font-bold">immediately notify</strong> KALLKEYY at <a href="mailto:support@kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400">support@kallkeyy.com</a> if you suspect:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">KALLKEYY&#39;s Rights:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY reserves the <strong className="font-bold">absolute and unconditional right</strong> to suspend, restrict, or terminate your Account at any time, with or without notice, for any reason, including but not limited to:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">User-Initiated Termination:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Effect of Termination:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Product Information:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Limitations and Disclaimers:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Despite reasonable efforts to ensure accuracy, KALLKEYY <strong className="font-bold">does not guarantee</strong> that:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Typographical Errors:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Subject to Availability:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Inventory Limitations:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Out-of-Stock Products:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Customization (if offered):</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Pre-Orders and Made-to-Order:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY reserves the <strong className="font-bold">absolute and unconditional right</strong> to refuse service, limit quantities, or refuse to accept or fulfill any Order for any reason, including but not limited to:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Display Currency:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- All prices displayed on the Platform are in <strong className="font-bold">Indian Rupees (INR)</strong> unless otherwise expressly stated</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Prices are <strong className="font-bold">inclusive of applicable taxes</strong> unless stated otherwise (GST, VAT, or other statutory levies as applicable)</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Pricing Changes:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Taxes and Duties:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Prices include applicable <strong className="font-bold">Goods and Services Tax (GST)</strong> as required by Indian law</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- For international orders (if applicable), additional customs duties, import taxes, or fees may apply and are the <strong className="font-bold">sole responsibility of the Customer</strong></p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">6.2 Payment Methods and Processing</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Accepted Payment Methods:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Payment Gateway:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- All payments are processed through <strong className="font-bold">Razorpay</strong>, a <strong className="font-bold">PCI-DSS Level 1 compliant</strong> payment gateway</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY <strong className="font-bold">does not collect, store, or process</strong> payment card information directly</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Payment Authorization:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">By providing payment information, you represent and warrant that:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You are <strong className="font-bold">authorized</strong> to use the selected payment method</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Sufficient funds or credit</strong> are available to complete the transaction</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Payment information is <strong className="font-bold">accurate and complete</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You will <strong className="font-bold">not dispute legitimate charges</strong> or initiate chargebacks fraudulently</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Payment Processing Timeline:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Payment is <strong className="font-bold">authorized and charged</strong> at the time of Order placement (except for pre-orders, which may be charged at shipment)</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Payment Failures:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">If payment fails due to insufficient funds, incorrect details, bank decline, or technical issues:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- The Order will <strong className="font-bold">not be processed</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Duplicate Charges:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Third-Party Payment Errors:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY is <strong className="font-bold">not responsible</strong> for:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Promotional Codes:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Restrictions:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Only <strong className="font-bold">one promotional code</strong> may be applied per Order unless otherwise stated</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Promotional codes are <strong className="font-bold">non-transferable</strong> and have no cash value</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Promotional codes <strong className="font-bold">cannot be redeemed retroactively</strong> for past purchases</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Price Adjustments:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY does <strong className="font-bold">not offer price adjustments</strong> if a Product goes on sale after you purchase it</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Order Process:</strong></p>
      <ol className="list-decimal list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Order Submission ≠ Order Acceptance:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Submitting an Order does <strong className="font-bold">not</strong> constitute a binding contract</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- An Order is merely an <strong className="font-bold">offer to purchase</strong> Products at the stated price</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Order Confirmation Email:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Upon successful Order placement and payment authorization, you will receive an <strong className="font-bold">Order Confirmation Email</strong> at the email address provided</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Contract Formation:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- A <strong className="font-bold">binding contract</strong> is formed <strong className="font-bold">only when</strong> KALLKEYY sends you an Order Confirmation Email</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Until you receive an Order Confirmation Email, KALLKEYY has <strong className="font-bold">not accepted</strong> your Order and may reject it for any reason</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY reserves the right to cancel any Order, before or after Order Confirmation, for reasons including but not limited to:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Cancellation Notification:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Cancellation Window:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You may cancel an Order <strong className="font-bold">before it is shipped</strong> by contacting <a href="mailto:support@kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400">support@kallkeyy.com</a></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Once an Order is shipped, it <strong className="font-bold">cannot be canceled</strong> (but may be eligible for return per the Return Policy)</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Cancellation Process:</strong></p>
      <ol className="list-decimal list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Cancellation Fees:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Logistics Partners:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Orders are processed, packed, and shipped through our logistics partners, including <strong className="font-bold">Shiprocket</strong> and other authorized couriers</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">KALLKEYY does not directly operate delivery services</li>
      </ul>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Order Processing Time:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Orders are typically processed within <strong className="font-bold">1-3 Business Days</strong> after Order Confirmation</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Address Requirements:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You must provide a <strong className="font-bold">complete, accurate, and deliverable</strong> shipping address, including:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Address Changes:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Address changes <strong className="font-bold">must be requested immediately</strong> by contacting <a href="mailto:support@kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400">support@kallkeyy.com</a></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Once an Order is shipped, address changes are generally <strong className="font-bold">not possible</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">PO Boxes and Military Addresses:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Estimated Delivery:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Delivery Timeline Ranges:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Metro Cities:</strong> Typically 3-5 Business Days</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Tier 2/3 Cities:</strong> Typically 5-7 Business Days</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Remote Areas:</strong> Typically 7-10 Business Days</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">International (if applicable):</strong> Varies by destination country (10-21 Business Days)</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Delivery Delays:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY is <strong className="font-bold">not liable</strong> for delivery delays caused by:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Delivery Confirmation:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Products are considered <strong className="font-bold">delivered</strong> when handed over to the recipient or an authorized person at the delivery address</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Transfer of Risk:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Title and risk of loss</strong> pass to you upon delivery of the Product to the specified address</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Failed Delivery Attempts:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Unclaimed or Refused Deliveries:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Tracking Information:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Once your Order is shipped, you will receive a <strong className="font-bold">Shipment Confirmation Email</strong> with:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Tracking Updates:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">Returns and exchanges are governed by the <strong className="font-bold">KALLKEYY Return, Refund, and Exchange Policy</strong>, which is incorporated into these Terms by reference and available at www.kallkeyy.com/returns.</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">9.2 Eligibility Criteria</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Products Eligible for Return/Exchange:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Products NOT Eligible for Return/Exchange:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Initiating a Return/Exchange:</strong></p>
      <ol className="list-decimal list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Return Shipping:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Prepaid Return Shipping:</strong> For defective, damaged, or incorrect Products, KALLKEYY will arrange prepaid courier pickup at no cost to you</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Self-Paid Return Shipping:</strong> For change-of-mind returns or size exchanges, you may be responsible for return shipping costs (as specified in Return Policy)</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Inspection and Verification:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Refund Processing:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Refund Amount:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Partial Refunds:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY reserves the right to issue partial refunds if:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Exchange Process:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Exchange Timeline:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Exchanges are processed within <strong className="font-bold">7-10 Business Days</strong> after receiving and verifying the returned Product</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Proprietary Rights:</strong></p>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Protected Elements Include:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Legal Protection:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">All Intellectual Property is protected under:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">You are <strong className="font-bold">strictly prohibited</strong> from:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Copying, reproducing, distributing, publishing, displaying, performing, modifying, creating derivative works, transmitting, or otherwise exploiting any Content without express <strong className="font-bold">written consent</strong> from KALLKEYY</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY grants you a <strong className="font-bold">limited, non-exclusive, non-transferable, revocable license</strong> to:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">This license does NOT permit you to:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY may <strong className="font-bold">revoke this license</strong> at any time without notice.</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">10.4 User Content and License Grant</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">User-Submitted Content:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">If you submit, post, upload, or transmit any User Content (reviews, ratings, photographs, comments, feedback, etc.) on or through the Platform:</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">You grant KALLKEYY:</strong></p>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">You represent and warrant that:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">Unauthorized use of KALLKEYY Intellectual Property:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Constitutes a <strong className="font-bold">breach of these Terms</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- May result in <strong className="font-bold">immediate Account termination</strong> and suspension of Services</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- May result in <strong className="font-bold">civil and criminal liability</strong> under applicable copyright, trademark, and intellectual property laws</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- May result in KALLKEYY pursuing <strong className="font-bold">legal remedies</strong>, including but not limited to injunctive relief, damages, and attorneys&#39; fees</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Reporting Intellectual Property Infringement:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">If you believe your intellectual property rights have been infringed on the Platform, contact <a href="mailto:support@kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400">support@kallkeyy.com</a> with:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">By using the Platform, you agree to:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Comply</strong> with all applicable laws, regulations, and these Terms</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Use the Platform only for <strong className="font-bold">lawful purposes</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Provide <strong className="font-bold">accurate and truthful</strong> information</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Maintain the <strong className="font-bold">security</strong> of your Account credentials</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Respect</strong> the rights of KALLKEYY and other Users</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Use the Platform in a manner that does <strong className="font-bold">not disrupt</strong> its operation or harm KALLKEYY&#39;s reputation</p>
      <br />
      ...
      <p className="text-gray-700 mb-4 leading-relaxed">You are <strong className="font-bold">strictly prohibited</strong> from:</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Fraudulent or Illegal Activities:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Unauthorized Access and Interference:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Data Mining and Scraping:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Reverse Engineering:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">Reverse engineering, decompiling, disassembling, or attempting to derive source code from the Platform</li>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Impersonation and Misrepresentation:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Spam and Unsolicited Communications:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Offensive or Harmful Content:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Competitive or Malicious Activities:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">Violation of these prohibitions may result in:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Immediate Account suspension or termination</strong> without notice</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Legal action</strong>, including civil and criminal prosecution</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Liability</strong> for damages, losses, costs, and expenses incurred by KALLKEYY</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Reporting</strong> to law enforcement or regulatory authorities</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Forfeiture</strong> of any outstanding balances, credits, or rewards</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY reserves the right to <strong className="font-bold">cooperate</strong> with law enforcement authorities and provide User information in connection with investigations of illegal activity.</p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">The Platform integrates and relies upon third-party services to facilitate operations, including but not limited to:</p>
      <br />
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Important Disclaimer:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY does <strong className="font-bold">not control, operate, or assume responsibility</strong> for the actions, policies, practices, or performance of Third-Party Service Providers</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY is <strong className="font-bold">not responsible</strong> for:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Your Responsibility:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Your use of third-party services is subject to the <strong className="font-bold">terms of service and privacy policies</strong> of those Third-Party Service Providers</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You are encouraged to <strong className="font-bold">review</strong> the terms and privacy policies of each Third-Party Service Provider before using their services</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY makes <strong className="font-bold">no representations or warranties</strong> regarding the practices or policies of Third-Party Service Providers</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">12.4 Third-Party Links</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">External Websites:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">No Warranties:</strong></p>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">TO THE MAXIMUM EXTENT PERMITTED BY LAW, KALLKEYY EXPRESSLY DISCLAIMS ALL WARRANTIES, INCLUDING BUT NOT LIMITED TO:</strong></p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">13.2 Disclaimers of Specific Warranties</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Merchantability and Fitness for Purpose:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY disclaims all warranties of <strong className="font-bold">merchantability</strong>, <strong className="font-bold">fitness for a particular purpose</strong>, <strong className="font-bold">quality</strong>, or <strong className="font-bold">suitability</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Non-Infringement:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY disclaims all warranties of <strong className="font-bold">non-infringement</strong> of third-party rights</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Accuracy and Completeness:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Uninterrupted or Error-Free Access:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">KALLKEYY does not warrant that:</li>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Third-Party Services:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">You Acknowledge and Accept That:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Use of the Platform and purchase of Products is <strong className="font-bold">at your sole risk</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">WHETHER ARISING FROM:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">EVEN IF KALLKEYY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</strong></p>
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">This limitation applies to all claims, collectively, including but not limited to:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">Breach of contract</li>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">You acknowledge and agree that:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- The limitations of liability set forth in this Section reflect a <strong className="font-bold">reasonable allocation of risk</strong> between you and KALLKEYY</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- These limitations are an <strong className="font-bold">essential basis of the bargain</strong> between you and KALLKEYY</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Your Conduct:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Your Account:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Product Use:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Third-Party Claims:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Your Obligations:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You must <strong className="font-bold">promptly notify</strong> KALLKEYY of any claim for which you are required to indemnify the Indemnified Parties</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You must provide KALLKEYY with <strong className="font-bold">reasonable cooperation and assistance</strong> in defending such claim</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You must <strong className="font-bold">not settle</strong> any claim without KALLKEYY&#39;s prior written consent</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">KALLKEYY&#39;s Rights:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- KALLKEYY reserves the right to <strong className="font-bold">assume exclusive defense and control</strong> of any claim subject to indemnification</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">Your indemnification obligations shall <strong className="font-bold">survive</strong> termination of these Terms, closure of your Account, or cessation of your use of the Platform.</p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Grounds for Termination:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">Violation of these Terms or any applicable policy</li>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Effect of Termination by KALLKEYY:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">Upon termination:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">User-Initiated Termination:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">You may terminate your Account and cease using the Platform at any time by:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Effect of User Termination:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">Your personal data will be processed according to our Privacy Policy</li>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">The following provisions shall <strong className="font-bold">survive termination</strong> of these Terms:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">&quot;<strong className="font-bold">Force Majeure Event</strong>&quot; means any event, circumstance, or cause beyond KALLKEYY&#39;s reasonable control that prevents, delays, or hinders KALLKEYY&#39;s performance of its obligations under these Terms, including but not limited to:</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Natural Disasters:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Government Actions:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Civil Disturbances:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Technical and Infrastructure Failures:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Supply Chain Disruptions:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Other Unforeseeable Events:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Suspension of Obligations:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">If a Force Majeure Event occurs, KALLKEYY&#39;s obligations under these Terms shall be <strong className="font-bold">suspended</strong> to the extent and for the duration that performance is prevented, delayed, or hindered by the Force Majeure Event.</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">No Liability:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY shall <strong className="font-bold">not be liable</strong> for:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Notification:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY will make reasonable efforts to notify affected Users of a Force Majeure Event and its expected impact on Orders, deliveries, or Services.</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Mitigation:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY will use commercially reasonable efforts to mitigate the impact of the Force Majeure Event and resume normal operations as soon as reasonably practicable.</p>
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Applicable Laws Include:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">The Indian Contract Act, 1872</li>
        <li className="mb-2 leading-relaxed">The Consumer Protection Act, 2019</li>
        <li className="mb-2 leading-relaxed">The Consumer Protection (E-Commerce) Rules, 2020</li>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">You <strong className="font-bold">irrevocably and unconditionally agree</strong> that:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Any disputes, claims, or controversies arising out of or related to these Terms, the Platform, or any Products or Services shall be subject to the <strong className="font-bold">exclusive jurisdiction of the competent courts located in New Delhi, India</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You <strong className="font-bold">consent to personal jurisdiction</strong> in New Delhi, India</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You <strong className="font-bold">waive any objection</strong> to venue or forum non conveniens in New Delhi, India</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You <strong className="font-bold">will not bring any action</strong> in any other jurisdiction or forum</p>
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Informal Resolution:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">Before initiating arbitration or litigation, you agree to attempt to resolve any dispute informally by:</p>
      <ol className="list-decimal list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Arbitration Agreement:</strong></p>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Arbitration Procedures:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Seat of Arbitration:</strong> New Delhi, India</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Language:</strong> English</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Number of Arbitrators:</strong> One (1) arbitrator mutually agreed upon by the parties; if no agreement within 30 days, appointed by the appointing authority under the Arbitration and Conciliation Act, 1996</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Governing Rules:</strong> Indian Arbitration and Conciliation Act, 1996</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Arbitration Costs:</strong> Each party shall bear its own costs and fees; arbitrator&#39;s fees shall be shared equally unless the arbitrator awards otherwise</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Arbitration Award:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- The arbitrator&#39;s decision and award shall be <strong className="font-bold">final and binding</strong> on both parties</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">The following disputes are <strong className="font-bold">excluded from arbitration</strong> and may be brought in court:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">YOU AND KALLKEYY AGREE THAT:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- All disputes shall be resolved on an <strong className="font-bold">individual basis only</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You <strong className="font-bold">waive the right</strong> to participate in any class action, collective action, or representative proceeding</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- You <strong className="font-bold">may not</strong> act as a class representative, private attorney general, or in any representative capacity</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">If the class action waiver is found to be unenforceable, the arbitration agreement shall be void, and disputes shall be resolved in court in accordance with Section 18 (Governing Law and Jurisdiction).</strong></p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">19.5 Survival</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">This arbitration agreement shall <strong className="font-bold">survive</strong> termination of these Terms.</p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">These Terms, together with:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">If any provision of these Terms is held to be <strong className="font-bold">invalid, illegal, or unenforceable</strong> by a court of competent jurisdiction or arbitrator:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Such provision shall be <strong className="font-bold">modified</strong> to the minimum extent necessary to make it valid and enforceable</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- If modification is not possible, the provision shall be <strong className="font-bold">severed</strong> from these Terms</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- The <strong className="font-bold">remaining provisions</strong> shall remain in full force and effect</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- The invalidity of one provision shall <strong className="font-bold">not affect</strong> the validity or enforceability of any other provision</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">20.3 Waiver</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">No Waiver by Failure to Enforce:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY&#39;s failure to enforce any provision of these Terms, or to exercise any right or remedy, shall <strong className="font-bold">not constitute a waiver</strong> of such provision, right, or remedy.</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">No Continuing Waiver:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">No waiver by KALLKEYY of any breach or default shall be deemed a <strong className="font-bold">continuing waiver</strong> or a waiver of any other breach or default.</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Waiver Must Be in Writing:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">Any waiver must be <strong className="font-bold">in writing and signed</strong> by an authorized representative of KALLKEYY to be effective.</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">20.4 Assignment</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">KALLKEYY&#39;s Right to Assign:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY may assign, transfer, or delegate these Terms or any rights or obligations hereunder to any third party (including in connection with a merger, acquisition, sale of assets, or restructuring) <strong className="font-bold">without your consent</strong>.</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Your Restriction on Assignment:</strong></p>
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY reserves the <strong className="font-bold">unconditional and absolute right</strong> to modify, amend, update, or replace these Terms at any time, in its sole discretion, for any reason, including but not limited to:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Material Changes:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">For material changes affecting your rights or obligations:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Notice will be provided via <strong className="font-bold">website banner</strong>, <strong className="font-bold">email notification</strong> to your registered email address, or <strong className="font-bold">in-platform alert</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Material changes will be effective <strong className="font-bold">30 days after posting</strong> or such longer period as required by law</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Non-Material Changes:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">For non-material changes (clarifications, corrections, or administrative updates):</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Continued Use Constitutes Acceptance:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- Your continued use of the Platform after the effective date of any changes constitutes your <strong className="font-bold">binding acceptance</strong> of the modified Terms</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- If you do not agree to the modified Terms, you must <strong className="font-bold">immediately discontinue use</strong> of the Platform and close your Account</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Review Responsibility:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- It is <strong className="font-bold">your responsibility</strong> to review these Terms periodically for updates</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY may maintain archives of previous versions of these Terms. You may request access to previous versions by contacting <a href="mailto:support@kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400">support@kallkeyy.com</a>.</p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">All notices, requests, demands, or other communications to KALLKEYY under these Terms must be in <strong className="font-bold">writing</strong> and delivered via:</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Email:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">support@kallkeyy.com</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Postal Mail:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">KALLKEYY</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Effective Date of Notices:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">Notices to KALLKEYY are deemed received:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Email:</strong> Upon transmission (if sent during Business Hours) or the next Business Day (if sent outside Business Hours)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Postal Mail:</strong> 5 Business Days after posting</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">22.2 Notices to Users</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">KALLKEYY may provide notices, communications, or disclosures to you via:</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Email:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">In-Platform Notifications:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Website Banner:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
        <li className="mb-2 leading-relaxed">Prominent notices displayed on the homepage or throughout the Platform</li>
      </ul>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">SMS or WhatsApp:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Effective Date of Notices:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">Notices to you are deemed received:</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">Email:</strong> Immediately upon transmission or within 24 hours (whichever is earlier)</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">In-Platform:</strong> Upon display or posting</p>
      <p className="text-gray-700 mb-4 leading-relaxed">- <strong className="font-bold">SMS/WhatsApp:</strong> Upon transmission</p>
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Contact Information:</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">For any questions, concerns, complaints, or support requests, contact:</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Email:</strong> <a href="mailto:support@kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400">support@kallkeyy.com</a></p>
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Response Time:</strong> 1-2 Business Days for acknowledgment; resolution within 5-7 Business Days (depending on complexity)</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Support Hours:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">What We Can Help With:</strong></p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">Nothing in these Terms creates any partnership, joint venture, employment, agency, or franchise relationship between you and KALLKEYY. You have no authority to bind KALLKEYY or make representations on its behalf.</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">24.2 Independent Contractors</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">You and KALLKEYY are independent contractors. KALLKEYY is not your employer, and you are not KALLKEYY&#39;s employee, agent, or representative.</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">24.3 No Third-Party Beneficiaries</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">These Terms are for the benefit of you and KALLKEYY only. No third party (except the Indemnified Parties under Section 15) has any right to enforce or rely upon these Terms.</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">24.4 Interpretation</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">In case of ambiguity or conflict:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">These Terms may be accepted electronically (by clicking &quot;I Agree,&quot; using the Platform, or creating an Account). Electronic acceptance has the same legal effect as a handwritten signature.</p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">By accessing, browsing, or using the Platform, creating an Account, or placing an Order, you <strong className="font-bold">explicitly acknowledge and confirm</strong> that:</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">1. You have <strong className="font-bold">read these Terms in their entirety</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">2. You <strong className="font-bold">understand these Terms</strong> and agree to be bound by them</p>
      <p className="text-gray-700 mb-4 leading-relaxed">3. You <strong className="font-bold">consent to all provisions</strong> set forth herein, including:</p>
      <ul className="list-disc list-inside mb-6 text-gray-700 space-y-2 ml-4">
      ...
      <p className="text-gray-700 mb-4 leading-relaxed">4. You have the <strong className="font-bold">legal capacity</strong> to enter into binding contracts</p>
      <p className="text-gray-700 mb-4 leading-relaxed">5. You are <strong className="font-bold">not prohibited</strong> from using the Platform under applicable law</p>
      <p className="text-gray-700 mb-4 leading-relaxed">6. You <strong className="font-bold">accept responsibility</strong> for compliance with these Terms</p>
      <p className="text-gray-700 mb-4 leading-relaxed">7. You <strong className="font-bold">acknowledge the risks</strong> associated with using the Platform and purchasing Products</p>
      <p className="text-gray-700 mb-4 leading-relaxed">8. You have been given the <strong className="font-bold">opportunity to seek legal advice</strong> before accepting these Terms</p>
      <br />

      <h3 className="text-2xl font-semibold mt-8 mb-4 text-[#b90e0a]">25.2 Voluntary and Informed Consent</h3>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">You acknowledge that your acceptance of these Terms is <strong className="font-bold">voluntary, informed, and without coercion</strong>, and that you have had adequate opportunity to review and understand the provisions herein.</p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      ...
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed">For any questions, complaints, legal notices, or support requests, please contact:</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">KALLKEYY</strong></p>
      <p className="text-gray-700 mb-4 leading-relaxed">Dwarka, New Delhi, India</p>
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">Email:</strong> <a href="mailto:support@kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400">support@kallkeyy.com</a></p>
        <p className="text-gray-700 text-sm"><strong className="font-bold">Website:</strong> <a href="https://www.kallkeyy.com" className="text-[#b90e0a] underline hover:text-red-400" target="_blank" rel="noopener noreferrer">www.kallkeyy.com</a></p>
      <br />
      <hr className="my-8 border-black/10" />
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">EFFECTIVE DATE:</strong> November 1, 2025</p>
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">LAST UPDATED:</strong> November 1, 2025</p>
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">© 2025 KALLKEYY. All Rights Reserved.</strong></p>
      <br />
      ...
      <hr className="my-8 border-black/10" />
      <br />
      <p className="text-gray-700 mb-4 leading-relaxed"><strong className="font-bold">END OF TERMS OF SERVICE</strong></p>
        </div>
      </div>
